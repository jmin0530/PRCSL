...
def main(argv=None):
    ...
    parser.add_argument('--lamb-distill', default=1.0, type=float, required=False,
                        help='Distillation loss lambda (default=%(default)s)')
    parser.add_argument('--lamb-distill-ewc', default=5000.0, type=float, required=False,
                        help='EWC loss penalty lambda (default=%(default)s)')
    parser.add_argument('--lamb-distill-mas', default=1.0, type=float, required=False,
                        help='MAS loss penalty lambda (default=%(default)s)')
...
#             nn.init.constant_(m.bias, 0)
    ...
    appr.lamb_ewc = args.lamb_distill_ewc
    appr.lamb_mas = args.lamb_distill_mas
